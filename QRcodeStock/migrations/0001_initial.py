    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comprimento', models.DecimalField(blank=True, decimal_places=2, default=1.0, max_digits=3, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_usuario_criador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='QRcodeStock.usuario', verbose_name='Usuario criador')),
            ],
            options={
